...
const Contactside = () => {
  return (
    <div className="rounded-lg dark:bg-slate-900 dark:border-none  md:w-[35%] w-full  mx-auto  h-auto shadow-lg border-2 ">
      <div className="m-8 rounded-lg dark:border-none border-2">
        <Image
          className="overflow-hidden rounded-lg hover:scale-105 ease  transition-transform duration-500 dark:opacity-30"
          src={contact}
          alt="image"
        />
      </div>
        ...
        <div className="">
          ...
          <div className="flex justify-start items-center  gap-4 mt-8 mb-8">
            <div whileHover={{ y: -4 }}>
              ...
              <FiLinkedin className=" dark:text-white hovericon transition-all duration-700 bg-transparent text-black text-5xl  shadow-md p-3 rounded-md " />
              </Link>
            </div>
            <div whileHover={{ y: -4 }}>
              <Link href='https://github.com/Santoshalimkar'>

              <AiFillGithub className="dark:text-white hovericon transition-all duration-700 bg-transparent text-black text-5xl  shadow-md p-3 rounded-md " />
              </Link>
            </div>
            <div whileHover={{ y: -4 }}>
              <Link href='https://www.freelancer.in/u/santoshsa4d'>
              <SiFreelancer className="dark:text-white hovericon transition-all duration-700 bg-transparent text-black text-5xl  shadow-md p-3 rounded-md " />
