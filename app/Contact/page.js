...
const page = () => {
  return (
    <div className="blurback bg-[#ecf0f3] dark:bg-slate-900 dark:border-none h-auto w-full border-b-2 ">
      <div>
        ...
        <div className="flex flex-col mt-4 md:flex-row sm:flex-col mb-8 dark:mb-0 md:mr-4 md:p-0 p-4  ">
          <Contactside />
          <Contactform />
        </div>
      </div>
