  ...
  return (
    ...
    <div>
     <div className='text-center mx-auto p-12'>
         <p  className='uppercase tracking-widest text-xs font-thin mb-4 leading-3 text-[#f9004d]'>contact</p>
         <h1 className='md:text-4xl text-3xl font-bold text-[#3c3e41] leading-7 tracking-wide'>Contact with me</h1>
     </div>
